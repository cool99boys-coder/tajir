...
export function Success() {
  ...
  const telegramUrl = "https://t.me/tajirempire";
  ...
  return (
    <main className="flex min-h-screen w-full items-center justify-center bg-ink-950 px-4 pb-16 pt-32 sm:pt-40">
      <div className="w-full max-w-xl text-center">
        ...
        >
          Thank you
          {state.name ? `, ${state.name.split(" ")[0]}` : ""}. Your order has
          been received and your payment screenshot is waiting for
          confirmation.
        </motion.p>
        ...
        >
          <Button
            asChild
            size="lg"
            className="w-full bg-emerald-glow text-ink-950 hover:bg-emerald-glow/90 shadow-[0_10px_30px_-8px_rgba(52,211,153,0.5)] sm:flex-1"
          >
            <a
              href={telegramUrl}
              target="_blank"
